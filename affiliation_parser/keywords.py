...
COUNTRY = (
    ...
    ("bonaire, sint eustatius and saba", "nan"),
    ("botswana", "nan"),
    ("bouvet island", "nan"),
    ...
    ("kenya", "nan"),
    ("kiribati", "nan"),
    ("korea, democratic people's republic of", "nan"),
    ...
    ("pakistan", "nan"),
    ("palau", "nan"),
    ("palestinian territory, occupied", "nan"),
    ("panama", "nan"),
